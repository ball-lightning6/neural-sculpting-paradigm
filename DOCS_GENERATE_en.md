...
## 1. **to_be_organized/symbolic_math_logic/generate_conditional_add_subtract.py**
...
## 2. **to_be_organized/symbolic_math_logic/generate_add_binary_modulo.py**
...
## 3. **to_be_organized/symbolic_math_logic/generate_multiply_binary.py**
...
## 4. **to_be_organized/symbolic_math_logic/generate_multiply_binary_no_carry_phase1.py**
...
## 5. **to_be_organized/symbolic_math_logic/generate_multiply_binary_from_counts_phase2.py**
...
## 6. **to_be_organized/symbolic_math_logic/generate_add_hexadecimal.py**
...
## 7. **to_be_organized/symbolic_math_logic/generate_multiply_decimal.py**
...
## 8. **generate_add_n_base_with_shuffle.py (Actual filename: to_be_organized/symbolic_math_logic/generate_symbol_add_shuffle_dataset.py)**
...
## 9. **to_be_organized/symbolic_math_logic/generate_add_binary_with_position_shuffle.py**
...
## 10. **to_be_organized/symbolic_math_logic/generate_add_hidden_constant.py**
...
## 11. **to_be_organized/symbolic_math_logic/generate_multitask_alu.py**
...
## 12. **to_be_organized/symbolic_math_logic/generate_modulo_operation.py**
...
## 13. **to_be_organized/symbolic_math_logic/generate_rsa_encryption.py**
...
## 14. **to_be_organized/cellular_automata/generate_cellular_automata_1d.py**
...
## 15. **to_be_organized/cellular_automata/generate_game_of_life_2d.py**
...
## 16. **to_be_organized/cellular_automata/generate_cellular_automata_1d_multistate.py**
...
## 17. **to_be_organized/cellular_automata/generate_cellular_automata_programmable.py**
...
## 18. **to_be_organized/symbolic_math_logic/generate_deduction_chain_text.py**
...
## 19. **to_be_organized/symbolic_math_logic/generate_deduction_multirule_text.py**
...
## 20. **to_be_organized/symbolic_math_logic/generate_deduction_multirule_text_v2.py**
...
## 21. **to_be_organized/symbolic_math_logic/generate_deduction_multirule_binary.py**
...
## 22. **to_be_organized/symbolic_math_logic/generate_deduction_fixed_depth.py**
...
## 23. **to_be_organized/symbolic_math_logic/generate_function_composition.py**
...
## 24. **to_be_organized/cellular_automata/generate_cellular_automata_inverse_rule90.py**
...
- **I/O Format:**
    - Input: A binary string of `N` bits (post-evolution state).
    - Output: A binary string of `N` bits (pre-evolution state).
- **Main Parameters:** `num_samples`, `length`.

---

## 25. **to_be_organized/symbolic_math_logic/generate_count_set_bits.py**
...
## 26. **to_be_organized/symbolic_math_logic/generate_sum_pattern_positions.py**
...
## 27. **to_be_organized/symbolic_math_logic/generate_sum_pattern_positions_v2.py**
...
## 28. **to_be_organized/symbolic_math_logic/generate_sum_pairwise_hamming_distance.py**
...
## 29. **to_be_organized/symbolic_math_logic/generate_circular_shift.py**
...
## 30. **to_be_organized/symbolic_math_logic/generate_multiply_matrix_3x3.py**
...
## 31. **to_be_organized/symbolic_math_logic/generate_evaluate_boolean_expression_text.py**
...
## 32. **to_be_organized/symbolic_math_logic/generate_evaluate_arithmetic_expression.py**
...
## 33. **to_be_organized/symbolic_math_logic/generate_evaluate_arithmetic_expression_no_multiply.py**

- **Purpose:** This is a simplified version of `to_be_organized/symbolic_math_logic/generate_evaluate_arithmetic_expression.py`, designed to reduce the learning difficulty by removing the multiplication operation, in order to test the model's ability on more basic arithmetic expression evaluation.
...
## 34. **to_be_organized/symbolic_math_logic/generate_evaluate_arithmetic_expression_no_multiply_small_range.py**
...
## 35. **to_be_organized/symbolic_math_logic/generate_check_boolean_equivalence.py**
...
## 36. **to_be_organized/function_approx/generate_polynomial_shift_coefficients.py**
...
## 37. **to_be_organized/visual_reasoning_arc/generate_convolution_2d.py**
...
## 38. **to_be_organized/symbolic_math_logic/generate_simple_block_cipher.py**
...
## 39. **to_be_organized/function_approx/generate_sin_function_float32.py**
...
## 40. **to_be_organized/function_approx/generate_sin_function_float64_to_int12_deprecated.py**
...
- **Status:** (Deprecated) This is an early, problematic version that has been replaced by the more successful `to_be_organized/function_approx/generate_sin_function_float32_to_quantized_int.py`.

---

## 41. **to_be_organized/function_approx/generate_sin_function_float32_to_quantized_int.py**
...
## 42. **to_be_organized/symbolic_math_logic/generate_multiply_binary_modulo.py**
...
## 43. **to_be_organized/symbolic_math_logic/generate_explainable_two_step_calculation.py**
...
## 44. **to_be_organized/games/generate_chess_positions_by_random_moves.py**
...
## 45. **to_be_organized/games/generate_chess_positions_by_random_placement.py**
...
## 46. **to_be_organized/games/generate_chess_positions_from_engine_self_play.py**
...
## 47. **to_be_organized/scripts_utils/generate_preprocess_legal_moves.py**
...
## 48. **to_be_organized/games/generate_chess_resolve_check_task.py**
...
## 1. **to_be_organized/algorithms/generate_sort_integers.py**
...
## 2. **to_be_organized/algorithms/generate_edit_distance.py**
...
## 3. **to_be_organized/algorithms/generate_edit_distance_explainable.py**
...
## 4. **to_be_organized/algorithms/generate_maze_random_walls.py**
...
## 5. **to_be_organized/algorithms/generate_maze_dense.py**
...
## 6. **to_be_organized/algorithms/generate_blocks_world_arbitrary_goal.py**
...
## 7. **to_be_organized/algorithms/generate_blocks_world_fixed_goal.py**
...
## 8. **to_be_organized/algorithms/generate_blocks_world_fixed_goal_multilabel.py**
...
## 9. **to_be_organized/algorithms/generate_blocks_world_fixed_goal_multilabel_fixed_format.py**
...
## 10. **to_be_organized/games/generate_checkers_jump_1d.py**
...
## 11. **to_be_organized/algorithms/generate_river_crossing_puzzle.py**
...
## 12. **to_be_organized/algorithms/generate_trapping_rain_water_aggregate.py**
...
## 13. **to_be_organized/algorithms/generate_trapping_rain_water_decoupled.py**
...
## 14. **to_be_organized/algorithms/generate_trapping_rain_water_2d.py**
...
## 15. **to_be_organized/algorithms/generate_skyline_max_height_aggregate.py**
...
## 16. **to_be_organized/algorithms/generate_skyline_all_heights_decoupled.py**
...
## 17. **to_be_organized/algorithms/generate_hanoi_tower_path_strategy_sep_format.py**
...
## 18. **to_be_organized/algorithms/generate_hanoi_tower_global_strategy_fixed_format.py**
...
## 19. **to_be_organized/algorithms/generate_hanoi_tower_compare_formats.py**
...
## 20. **to_be_organized/algorithms/generate_hanoi_tower_compare_formats_and_strategies.py**
...
## 21. **to_be_organized/algorithms/generate_hanoi_tower_build_full_state_graph.py**
...
## 22. **to_be_organized/algorithms/generate_hanoi_tower_sample_from_state_graph.py**

- **Purpose:** This is a post-processing and sampling script that utilizes the complete knowledge base generated by `to_be_organized/algorithms/generate_hanoi_tower_build_full_state_graph.py` to precisely extract specific types of training data subsets, such as "twisted paths" or the "hardest parts," for more fine-grained ablation studies.
...
## 23. **to_be_organized/algorithms/generate_sokoban_planning_astar.py**
...
## 24. **to_be_organized/algorithms/generate_sokoban_planning_full.py**
...
## 25. **to_be_organized/algorithms/generate_sokoban_planning_claude_deprecated.py**

- **Purpose:** (Deprecated) This was an earlier attempt with more complex logic, but it failed to consistently generate high-quality datasets and has been replaced by the more reliable `to_be_organized/algorithms/generate_sokoban_planning_full.py`.
- **Logic:** An early version attempting to solve the Sokoban problem.
- **Status:** **Deprecated**.

---

## 26. **to_be_organized/symbolic_math_logic/generate_min_swaps_for_checkerboard.py**
...
## 27. **to_be_organized/symbolic_math_logic/generate_min_flips_for_alternating_binary.py**
...
## 28. **to_be_organized/symbolic_math_logic/generate_min_swaps_for_checkerboard_v2.py**
...
## 29. **to_be_organized/algorithms/generate_matrix_flip_strategy.py**
...
## 30. **to_be_organized/algorithms/generate_matrix_flip_max_score.py**
...
## 31. **to_be_organized/symbolic_math_logic/generate_min_prefix_flips.py**
...
## 32. **to_be_organized/algorithms/generate_min_k_bit_flips.py**
...
## 33. **to_be_organized/algorithms/generate_min_k_bit_flips_fixed_k.py**
...
- **Logic:** The logic is the same as `to_be_organized/algorithms/generate_min_k_bit_flips.py`, but the length of the flipping window `k` is fixed to 2 and is not provided in the input.
- **I/O Format:**
...
## 34. **to_be_organized/algorithms/generate_special_binary_string_recursion.py**
...
## 35. **to_be_organized/symbolic_math_logic/generate_min_flips_for_chunked_binary.py**
...
## 36. **to_be_organized/algorithms/generate_count_connected_components.py**
...
## 37. **to_be_organized/algorithms/generate_check_graph_connectivity.py**
...
## 38. **to_be_organized/algorithms/generate_minimize_malware_spread.py**
...
## 39. **to_be_organized/algorithms/generate_count_islands_1d.py**
...
## 40. **to_be_organized/symbolic_math_logic/generate_largest_island_by_adding_one_cell.py**
...
## 41. **to_be_organized/symbolic_math_logic/generate_largest_island_by_adding_one_cell_v2.py**
...
## 42. **to_be_organized/algorithms/generate_find_articulation_points.py**
...
## 43. **to_be_organized/games/generate_nim_game_zeckendorf.py**
...
## 44. **to_be_organized/algorithms/generate_longest_subsequence_constrained.py**
...
## 45. **to_be_organized/games/generate_treasure_hunt_tsp.py**
...
## 46. **to_be_organized/algorithms/generate_freedom_trail_dp.py**
...
## 47. **to_be_organized/algorithms/generate_sum_of_subset_with_mask.py**
...
## 48. **to_be_organized/algorithms/generate_sudoku_6x6.py**
...
## 49. **to_be_organized/algorithms/generate_valid_parentheses_path_random_deprecated.py**

- **Purpose:** (Early exploration/Deprecated) An early attempt to solve the "Valid Parentheses Path" problem.
- **Status:** **Deprecated**. This script created datasets by randomly generating parenthesis grids, but this led to a severe data imbalance problem (the vast majority of random grids have no valid path), which is not conducive to model training. It has been replaced by `to_be_organized/algorithms/generate_valid_parentheses_path_balanced.py`.
...
## 50. **to_be_organized/algorithms/generate_valid_parentheses_path_balanced.py**
...
## 51. **to_be_organized/symbolic_math_logic/generate_sat_solver_text.py**
...
## 52. **to_be_organized/symbolic_math_logic/generate_sat_solver_compact_text.py**

- **Purpose:** A variant of `to_be_organized/symbolic_math_logic/generate_sat_solver_text.py` that uses a different input encoding format to solve the same 3-SAT problem.
...
## 53. **to_be_organized/visual_reasoning_arc/generate_point_in_polygon.py**
...
## 54. **to_be_organized/algorithms/generate_shortest_path_in_matrix_bfs.py**
...
## 55. **to_be_organized/algorithms/generate_sudoku_4x4_stepwise_deprecated.py**
...
- **Status:** **Deprecated**. The script attempted to generate stepwise solutions for 4x4 Sudoku using a complex backtracking logic, but its core algorithm was unreliable and could not guarantee the correctness and validity of the generated data. It has been replaced by more robust scripts like `to_be_organized/algorithms/generate_sudoku_6x6.py`.
...
## 56. **to_be_organized/algorithms/generate_tiling_problem_deprecated.py**
...
## 57. **to_be_organized/algorithms/generate_hanoi_tower_twisted_path_deprecated.py**
...
- **Status:** **Deprecated**. The core move logic (`apply_move`) was flawed and did not correctly simulate the "large disk below, small disk above" rule of Tower of Hanoi, resulting in generated paths that were not valid solutions. It was later superseded by more robust scripts like `to_be_organized/algorithms/generate_hanoi_tower_build_full_state_graph.py`.

---

## 58. **to_be_organized/games/generate_checkers_jump_1d_v2.py (Refer to to_be_organized/games/generate_checkers_jump_1d.py)**
...
## 1. **to_be_organized/visual_reasoning_arc/generate_checkerboard_to_binary.py**
...
## 2. **to_be_organized/visual_reasoning_arc/generate_line_angle_to_vector.py**
...
## 3. **to_be_organized/visual_reasoning_arc/generate_count_shapes_from_image.py**
...
## 4. **to_be_organized/algorithms/generate_maze_symbolic_to_image.py**
...
## 5. **to_be_organized/visual_reasoning_arc/generate_sokoban_symbolic_to_image_no_labels.py**
...
## 6. **to_be_organized/visual_reasoning_arc/generate_sokoban_symbolic_to_image_with_labels.py**
...
## 1. **to_be_organized/visual_reasoning_arc/generate_triangle_to_incircle.py**
...
## 2. **to_be_organized/visual_reasoning_arc/generate_polygon_to_symmetry_axis.py**
...
## 3. **to_be_organized/visual_reasoning_arc/generate_triangle_to_centroid.py**
...
## 4. **to_be_organized/visual_reasoning_arc/generate_triangle_to_tessellation.py**
...
## 5. **to_be_organized/cellular_automata/generate_game_of_life_image_to_image.py**
...
## 6. **to_be_organized/physics_simulation/generate_projectile_motion_simulation.py**
...
## 7. **to_be_organized/physics_simulation/generate_snell_refraction_simulation.py**
...
## 8. **to_be_organized/physics_simulation/generate_snell_refraction_with_contextual_index.py**
...
## 9. **to_be_organized/cellular_automata/generate_cellular_automata_spatial_conditional.py**
...
## 10. **to_be_organized/algorithms/generate_trapping_rain_water_visualizer.py**
...
## 11. **to_be_organized/algorithms/generate_shortest_path_in_tree_deprecated.py**
...
## 12. **to_be_organized/visual_reasoning_arc/generate_shortest_distance_between_triangles.py**
...
## 13. **to_be_organized/cellular_automata/generate_reaction_diffusion_deprecated.py**
...
## 14. **to_be_organized/cellular_automata/generate_cellular_automata_multimodal_deprecated.py**
...
- **Status:** **Deprecated**. Due to the lack of a suitable, easy-to-train multimodal model (within the experimental framework), and since `to_be_organized/cellular_automata/generate_cellular_automata_spatial_conditional.py` provided a cleaner alternative, the training set generated by this script was not used.
...
## 1. **to_be_organized/visual_reasoning_arc/generate_coords_to_triangle.py**
...
## 2. **to_be_organized/cellular_automata/generate_cellular_automata_1d_to_grid_image.py**
...
## 3. **to_be_organized/visual_reasoning_arc/generate_triangle_coords_to_tessellation.py**

- **Purpose:** This is an advanced reasoning task that combines symbolic instructions with geometric generation rules.
- **Logic:** Same as `to_be_organized/visual_reasoning_arc/generate_coords_to_triangle.py`, the input is a 48-bit binary string defining a base triangle. Same as `to_be_organized/visual_reasoning_arc/generate_triangle_to_tessellation.py`, the output is a perfect planar tessellation pattern based on this base triangle. The **key modification** is that in the output tessellation pattern, the base triangle directly defined by the input is colored specially (e.g., black), while the other triangles remain green and red. This provides the necessary "grounding" information for the model.
- **I/O Format:**
    - Input: A 48-bit binary string.
...
## 4. **to_be_organized/physics_simulation/generate_cube_rotation_matplotlib_deprecated.py**
...
## 5. **to_be_organized/physics_simulation/generate_cube_rotation_pillow_v1.py**
...
## 6. **to_be_organized/physics_simulation/generate_cube_rotation_pillow_with_anchor.py**
...
## 7. **to_be_organized/physics_simulation/generate_cube_rotation_pillow_wireframe.py**
...
## 1. **to_be_organized/physics_simulation/generate_catenary_curve_simulation_deprecated.py**
...
- **Logic:** This version was a preliminary attempt at the catenary problem, possibly using a numerical solver to reverse-engineer the catenary equation from given parameters like two endpoints and curve length. This method might have had numerical stability issues and was an early exploratory work, later replaced by the more robust method in `to_be_organized/physics_simulation/generate_catenary_curve_from_points.py`.
- **I/O Format:**
...
## 2. **to_be_organized/physics_simulation/generate_catenary_curve_from_points.py**
...
## 3. **to_be_organized/physics_simulation/generate_orbital_path_from_initial_state.py**
...
## 1. **to_be_organized/visual_reasoning_arc/generate_arc_contextual_color_swap.py**
...
## 2. **to_be_organized/visual_reasoning_arc/generate_arc_find_cross_pattern.py**
...
## 3. **to_be_organized/visual_reasoning_arc/generate_arc_find_odd_one_out.py**
...
## 4. **to_be_organized/visual_reasoning_arc/generate_arc_connect_colored_pairs.py**
...
## 5. **to_be_organized/visual_reasoning_arc/generate_arc_conditional_perpendicular_lines.py**
...
## 6. **to_be_organized/visual_reasoning_arc/generate_arc_column_projection.py**
...
## 7. **to_be_organized/visual_reasoning_arc/generate_arc_procedural_spiral.py**
...
## 8. **to_be_organized/visual_reasoning_arc/generate_arc_fractal_stamping.py**
...
## 9. **to_be_organized/visual_reasoning_arc/generate_arc_flood_fill.py**
...
## 10. **to_be_organized/visual_reasoning_arc/generate_arc_layered_fill.py**
...
## 11. **to_be_organized/visual_reasoning_arc/generate_arc_fluid_simulation.py**
...
## 12. **to_be_organized/visual_reasoning_arc/generate_arc_periodic_conditional_fill.py**
...
## 13. **to_be_organized/visual_reasoning_arc/generate_arc_fill_square_holes.py**
...
## 14. **to_be_organized/visual_reasoning_arc/generate_arc_conditional_recoloring.py**
...
## 15. **to_be_organized/visual_reasoning_arc/generate_arc_sort_by_length_remap_position.py**
...
## 16. **to_be_organized/visual_reasoning_arc/generate_arc_jigsaw_puzzle_simple.py**
...
## 17. **to_be_organized/visual_reasoning_arc/generate_arc_jigsaw_puzzle_advanced.py**
...
## 18. **to_be_organized/visual_reasoning_arc/generate_arc_connect_path_by_sequence.py**
...
## 19. **to_be_organized/visual_reasoning_arc/generate_arc_reflection_simulation_deprecated.py**
...
## 1. **to_be_organized/cellular_automata/generate_cellular_automata_inverse_rule.py**
...
- **Logic:** I first randomly select a cellular automaton rule (from 0 to 255). Then, **construct an initial state containing all 8 possible 3-bit neighborhood patterns (using a De Bruijn sequence)**. I apply this rule to evolve for a fixed number of steps to get a final state. This special initial state design ensures that the rule can be uniquely inferred. I concatenate the initial state and the final state as the model's input, and the hidden 8-bit rule as the model's prediction target.
- **I/O Format:**
...
## 2. **to_be_organized/cellular_automata/generate_cellular_automata_inverse_rule_and_steps.py**
...
## 3. **to_be_organized/cellular_automata/generate_cellular_automata_inverse_rule_and_steps_unique.py**
