...
def generate_dataset():
    ...
    for i in tqdm(range(NUM_SAMPLES)):
        ...
        binary_string_label=''
        base_triangle_pts = base_triangle_pts.tolist()
        for x,y in base_triangle_pts:
            binary_string_label+=f'{x:08b}{y:08b}'

        relative_filepath = os.path.join(f'output/' + filename)
