...
class Config:
    DATA_DIR = "refraction_dataset_v1.4_USER_LOGIC"
...
def create_single_sample(config):
    ...
    input_img = Image.new('RGB', (size, size), (0,255-new_color,new_color))
