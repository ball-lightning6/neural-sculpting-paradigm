...
> **新短论文：[《压缩即智能：重新理解神经网络泛化》](./research/neural_k_framework/papers/compression_is_intelligence_zh.md)** | [English Markdown](./research/neural_k_framework/papers/compression_is_intelligence_en.md) | [Zenodo PDF](https://doi.org/10.5281/zenodo.22255552)
...
3.  **[压缩即智能的 Neural K 解释](./research/neural_k_framework/papers/compression_is_intelligence_zh.md)**：固定网络、编码、损失和参数测度以后，函数先验高度不均匀；继续降低完整目标 loss 时，不同函数体积又会差异收缩，通常使更经济、可复用的实现获得相对优势。这与 MDL 和算法信息论自然相连，但复杂度是神经协议相对的 Neural K-profile，不直接等同机器无关 Kolmogorov complexity。
...
*   `research/`: 围绕神经网络学习机制展开的进一步实验
    *   `research/neural_k_framework/`: 最新 Neural K 理论核心、正式短论文、研究主文、证据总账、E01--E30 复现实验和中英文静态网站
...
*   **[📄 《压缩即智能：重新理解神经网络泛化》](./research/neural_k_framework/papers/compression_is_intelligence_zh.md)**: Neural K工作的正式简短研究说明；另见[英文版](./research/neural_k_framework/papers/compression_is_intelligence_en.md)与[Zenodo PDF](https://doi.org/10.5281/zenodo.22255552)。
*   **[🧭 Neural K 理论与证据包](./research/neural_k_framework/README.md)**: 最新理论核心、完整判决链、E01--E30 实验说明和复现脚本。
